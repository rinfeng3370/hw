...
--修改
\d |
create procedure updateP(in num int,in name varchar(40),in price decimal(19,4))
begin
declare exit handler for sqlstate '23000'
    begin
        select 'Error. No such SupplierID' as 'Error Message!';
    end;
    
    update Products set Pname=name,Unitprice=price where pnum=num;
